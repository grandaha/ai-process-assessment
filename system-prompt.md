...
| 9 | `ai-process-assessment:building-executive-summary` | Standalone 1–2 page executive summary | `deliverable-gate` cleared | `executive-summary.md` |
...
- After `deliverable-gate` clearance → invoke `ai-process-assessment:building-executive-summary` (Phase 9).
