...
description: Phase 11 section renderer — reads processes/PROC-NNN.md files and produces the #problem section: three oversized stat cards for the top three baseline gaps driving the engagement. Synthesis renderer — selects and formats; does not dump the full baselines table.
...
Synthesis renderer. Reads `processes/PROC-NNN.md` files and selects exactly three specified metrics to render as `.stat-card` elements. Does not dump the full baselines table. Output is one designed HTML section block.

## Inputs required

| Input | File | Required sections |
|---|---|---|
| Baselines | `processes/PROC-NNN.md` (relevant process files) | Time-to-fill metric, Day-1 incompletion metric, early attrition cost metric, source confidence notes |

You receive the relevant `processes/PROC-NNN.md` files only. No other source files.
...
<div class="section-block" id="problem">
  ...
  <div class="stat-row">
    ...
    <div class="stat-card">
      ...
      <div class="stat-context">[Value and confidence level verbatim from processes/PROC-NNN.md]</div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="stat-context">[Volume impact verbatim from processes/PROC-NNN.md]</div>
    </div>
    ...
    <div class="stat-card">
      ...
      <div class="stat-context">[Derivation note verbatim from processes/PROC-NNN.md]</div>
    </div>

  </div>
  <p class="gap-note">[Source file citation and confidence levels verbatim from processes/PROC-NNN.md]</p>
</div>
```
...
- `stat-context`: Pull the value and confidence level text verbatim from `processes/PROC-NNN.md`

**Card 2 — Day-1 incompletion:**
- `stat-value`: `46%`
- `stat-label`: `Day-1 Incompletion`
- `stat-sub`: `Onboarding tasks not done pre-start`
- `stat-context`: Pull the volume impact text verbatim from `processes/PROC-NNN.md`
...
- `stat-context`: Pull the derivation note verbatim from `processes/PROC-NNN.md`

**Below stat-row:**
- `<p class="gap-note">` — cite the source file and confidence levels verbatim from `processes/PROC-NNN.md`
...
- Source: relevant `processes/PROC-NNN.md` files only
